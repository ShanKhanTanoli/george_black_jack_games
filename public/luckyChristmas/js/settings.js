...
BONUS_PRIZE[0] = [5, 5, 1]; //LIST OF MULTIPLIER IF 3 BONUS ITEM
BONUS_PRIZE[1] = [1, 1, 2]; //LIST OF MULTIPLIER IF 4 BONUS ITEM
BONUS_PRIZE[2] = [5, 2, 5]; //LIST OF MULTIPLIER IF 5 BONUS ITEM
