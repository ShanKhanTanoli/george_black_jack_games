function CPreloader() {
    ...
    this._init = function() {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", window.location.origin + "/SlotRamses/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", window.location.origin + "/SlotRamses/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", window.location.origin + "/SlotRamses/sprites/but_start.png");
