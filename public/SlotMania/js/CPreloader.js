function CPreloader() {
    ...
    this._init = function() {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", window.location.origin + "/SlotMania/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", window.location.origin + "/SlotMania/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", window.location.origin + "/SlotMania/sprites/but_start.png");
