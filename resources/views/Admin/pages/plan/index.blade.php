                        ...
                        <div class="card card-custom">
                            <div class="card-header">
                                <div class="card-title">
                                    ...
                                    <h3 class="card-label">Our Plans & Pricing</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <!--begin: Search Form-->
                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{!! $plan->name !!}</td>
                                            <td>{!! Game::Info($plan->GameId)->name !!}</td>
                                            <td>{!! $plan->shortdescription !!}</td>
                                            <td>{!! $plan->price !!} USD</td>
                                            <td><a href="{{ route('AdminEditPlan',$plan->id) }}" class="btn btn-success btn-sm">Edit</a></td>
                                            <td>
                                                <form action="{{ route('AdminDeletePlan' ,$plan->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <div class="alert alert-danger">
                                    No Plans & Pricing Found &nbsp; <a href="{{ route('AdminCreatePlans') }}" class="btn btn-success">CREATE PLAN</a>
                                </div>
                                @endif
                                <!--end: Datatable-->
                                <!--end: Datatable-->
