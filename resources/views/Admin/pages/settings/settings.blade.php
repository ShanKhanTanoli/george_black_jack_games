                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="flex-row-fluid ml-lg-8">
                                ...
                                <div class="card card-custom card-stretch">
                                    ...
                                    <form class="form" method="POST" action="{{ route('AdminSaveSettings' , Site::hasLogo()->id) }}">
                                        @csrf
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <label>Site Title:</label>
                                                    <input type="text" name="sitetitle" value="{!! Site::hasLogo()->sitetitle !!}" class="form-control @error('sitetitle')is-invalid @enderror" placeholder="Enter Site Title">
                                                    <span class="form-text text-muted">Site Title will be used as Dashboard Logo</span>
                                                    @error('sitetitle')
