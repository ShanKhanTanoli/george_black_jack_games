                ...
                <div class="d-flex flex-column-fluid">
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex flex-row">
                            <!--begin::Aside-->
                            @include('Admin.partials.dashboard.userprofile-aside')
                            <!--end::Aside-->
                            <!--begin::Content-->
                            <!--begin::Content-->
                                ...
                                <div class="card card-custom card-stretch">
                                    ...
                                    <form class="form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!-- Image Starts here -->
                                            @include('Admin.partials.dashboard.profile-picture')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" type="email" name="email" value="{{ Auth::user()->email}}" />
                                                    @error('email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="card-toolbar">
                                                <button type="submit" formaction="{{ route('UpdateAdminProfile',Auth::user()->id) }}" class="btn btn-success mr-2">Save Changes</button>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                    </form>
